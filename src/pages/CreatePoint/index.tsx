...
import { FaCaretLeft, FaClipboardCheck, FaCheckCircle } from "react-icons/fa"
...
const CreatePoint = () => {
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        const { name, email, wpp, num } = formData
        const uf = selectedUF
        const city = SelectedCity
        const [latitude, logitude] = selectedPosition
        ...
        data.append("logitude", String(logitude))
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <fieldset>
                        ...
                        <div className="field-group">
                            ...
                            <div className="field">
                                <label htmlFor="wpp"></label>
                                <input
                                    placeholder="Whatsapp do Ponto"
                                    type="text"
                                    name="wpp"
                                    id="wpp"
                                    onChange={handleInputChange}
                    ...
                    <fieldset>
                        <legend>
                            <h2>Ítens que seu Ponto precisa</h2>
